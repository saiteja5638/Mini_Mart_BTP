		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Training Capm 3",
									"targetURL": "#trainingcapm3-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"trainingcapm3-display": {
								"semanticObject": "trainingcapm3",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=trainingcapm3",
									"url": sap.ui.require.toUrl("trainingcapm3")
								}
							}
						}
					}

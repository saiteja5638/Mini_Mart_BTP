		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#employeesmaster-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"employeesmaster-display": {
								"semanticObject": "employeesmaster",
								"action": "display",
								"description": "Employee Master Application",
								"title": "Employee Master Application",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=employeesmaster",
									"url": sap.ui.require.toUrl("employeesmaster")
								}
							}
						}
					}

		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#salespredictions-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"salespredictions-display": {
								"semanticObject": "salespredictions",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=salespredictions",
									"url": sap.ui.require.toUrl("salespredictions")
								}
							}
						}
					}
